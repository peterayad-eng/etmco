<main class=''>
    <ul class="nav nav-tabs filterbar">
        <li class="nav-item">
            <a href='#' class="nav-link navheadersize filterlink activefilter" aria-current="page" data-filter="all">All</a>
        </li>
        <?php
		...
		?>
            <li class="nav-item">
                <a href='#' id="<?=$category['id']?>" class="nav-link filterlink navheadersize" data-filter=".<?=$category['category']?>"><?=$category['button']?></a>
            </li>			
		<?php
		  }
		?>

...
<html lang="en">	
	...
	<body>
        <header class="navbar navbar-expand-md fixed-top adminnav">
            <div class="container-fluid">
                <a class="navbar-brand" href="index"><h1 class='nomargin'><image class='navlogo' src="../Images/logo.png" alt='ETMCO'/></h1></a>
                <h2 class="navheadersize nomargin blue">Hello, <?=$_SESSION['user']?></h2>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navul">
                        <li id='home-nav' class="nav-item ntab navheadersize ps-1 pe-1 activ"><a class="nav-link navlink active blue" aria-current="page" href="index">Products</a></li>
                        <li id='users-nav' class="nav-item ntab navheadersize ps-1 pe-1"><a class="nav-link navlink blue" href="users">Users</a></li>
                        <li class="nav-item langtab ps-2"><a class="nav-link navlink langlink blue" href="logout">Logout</a></li>
                    </ul>
                </div>
            </div>
        </header>